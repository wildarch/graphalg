...
#include "graphalg/GraphAlgTypeInterfaces.h.inc"

namespace graphalg {

#include "graphalg/GraphAlgOpInterfaces.h.inc"
...
template<typename T>
class IsCore
        : public mlir::OpTrait::TraitBase<T, IsCore> {
};
...
class SameOperandsAndResultSemiring
    : public mlir::OpTrait::TraitBase<ConcreteType, SameOperandsAndResultSemiring> {
public:
...
template<typename T>
class DenseResult
        : public mlir::OpTrait::TraitBase<T, DenseResult> {
public:
    void inferDensity(
...
template<typename T>
class PropagatesDense
        : public mlir::OpTrait::TraitBase<T, PropagatesDense> {
public:
    void inferDensity(
            llvm::ArrayRef<const DensityLattice*> operands,
            llvm::ArrayRef<DensityLattice*> results,
