...
class GraphAlgLoopAggregate : public impl::GraphAlgLoopAggregateBase<GraphAlgLoopAggregate> {
    using impl::GraphAlgLoopAggregateBase<GraphAlgLoopAggregate>::GraphAlgLoopAggregateBase;
...
void GraphAlgLoopAggregate::runOnOperation() {
    ...
    getOperation()->walk([&](ForConstOp op) {
        loopOps.emplace_back(op);
    });
    getOperation()->walk([&](ForDimOp op) {
        loopOps.emplace_back(op);
    });
