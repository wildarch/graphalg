...
func.func @Test(%arg0: !graphalg.mat<#dim x #dim1 x i64>, %arg1: !graphalg.mat<#dim x #dim1 x i64>) -> !graphalg.mat<#dim x #dim1 x i64> {
  // CHECK: %[[#APPLY:]] = graphalg.apply_inline %arg0, %arg1
  // CHECK:   -> <#dim x #dim1 x i64> {
  // CHECK:   %[[#RES:]] = graphalg.ewise %arg2 ADD %arg3 : <1 x 1 x i64>
  // CHECK:   graphalg.apply_inline.return %[[#RES]]
  %1 = graphalg.apply_elementwise @add %arg0, %arg1 : (!graphalg.mat<#dim x #dim1 x i64>, !graphalg.mat<#dim x #dim1 x i64>) -> !graphalg.mat<#dim x #dim1 x i64>
